...
export const sharedConfig = defineConfig({
  ...
  head: [
    ['link', { rel: 'icon', href: '/Icons/PageIcons/StarseaD&B.ico' }]
  ],
  lastUpdated: true,
  cleanUrls: true,
  themeConfig: {
    logo: '/Icons/PageIcons/StarseaD&B.svg',
    socialLinks: [
    ...
    footer: {
      message: 'The site uses the Apache 2.0 open source protocol and is deployed on GitHub Pages. (Please give me a Star QAQ)',
